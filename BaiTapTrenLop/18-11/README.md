# TCP Socket Application với fork()

Ứng dụng TCP socket sử dụng `fork()` để hỗ trợ nhận thông tin từ nhiều người dùng đồng thời.

## Yêu cầu

- Hệ điều hành Linux/Unix (có hỗ trợ fork())
- GCC compiler
...
- Sử dụng `fork()` để xử lý nhiều client đồng thời
